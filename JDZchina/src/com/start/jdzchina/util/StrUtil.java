...
public class StrUtil {
	...
	/**
	 * 删除最后一个"," cutLastlyComma(这里用一句话描述这个方法的作用)
	 * 
	...
	/**
	 * 删除第一个"," cutLastlyComma(这里用一句话描述这个方法的作用)
	 * 
	 * @Title: cutLastlyComma
	 * @Description: TODO
	 * @param @param s
	...
	/**
	 * 删除最后一个符号 cutLastlyComma(这里用一句话描述这个方法的作用)
	 * 
	 * @Title: cutLastlyComma
	 * @Description: TODO
	 * @param @param s
	...
	/**
	 * 返回以...结尾的字符串 subString(这里用一句话描述这个方法的作用)
	 * 
	 * @Title: subString
	 * @Description: TODO
	...
	/**
	 * 按字节截取字符串 subStringByByte(这里用一句话描述这个方法的作用)
	 * 
	...
	public static String formatTraffic(long trafficSize) {
		...
		} else if (trafficSize >= 1024 * 1024
				&& trafficSize < 1024 * 1024 * 1024) {
