...
public class DetailActivity_restaurant extends Activity {
	...
	private View getView() {
		...
		FrameLayout frameLayout = (FrameLayout) inflater.inflate(
				R.layout.detail_restaurant, null, false);
	...
	private void setData(TextView view, String key) {
		...
		} else if (key.endsWith("southeast")) {
