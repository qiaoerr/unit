/**
  @Title: TalentRecuitActivity.java
  @Package com.star.general.activity
  @Description: TODO
  Copyright: Copyright (c) 2011 
  
  @author Comsys-Administrator
  @date 2013-12-30 下午08:09:22
  @version V1.0
 */
...
/**
 * @ClassName: TalentRecuitActivity
 * @Description: TODO
 * @author Comsys-Administrator
 * @date 2013-12-30 下午08:09:22
 * 
...
public class TalentRecuitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.talent_recuit_layout);
		context = this;
		initData();
		initView();
	}
	...
	private void initView() {
		...
		content_textView
				.setText("本理发店生意兴旺，现扩大发展，急招美发业人士前来加盟合作，发型师，中工，学徒，不会者可免费培顺，工资待遇从优");
