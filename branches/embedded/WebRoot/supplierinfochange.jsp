...
<%
   ...
   String supplierdescription=Tools.getstr(request.getParameter("supplierdescription"));
   String linkedman=Tools.getstr(request.getParameter("linkedman"));
   String telphone=Tools.getstr(request.getParameter("telphone"));
   String address=Tools.getstr(request.getParameter("address"));
...
%>
<body>
 <form action=supplierinfochange.jsp method=get onSubmit="return check(this);">
