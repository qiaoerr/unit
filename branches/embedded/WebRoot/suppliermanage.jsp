...
//request.setCharacterEncoding("GBK");////////////////////////
 ...
 if(suppliername!=null){
   suppliername=Tools.getstr(request.getParameter("suppliername"));
 }
 if(supplierdescription!=null){
   supplierdescription=Tools.getstr(request.getParameter("supplierdescription"));
 }
...
%>
<body>
  <form action=suppliermanage.jsp method=get>
