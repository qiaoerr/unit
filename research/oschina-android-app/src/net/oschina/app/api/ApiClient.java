...
public class ApiClient {
	...
	public static void checkBackGround(AppContext appContext)
			throws AppException {
		try {
			WellcomeImage update = WellcomeImage.parse(http_get(appContext,
					URLs.UPDATE_VERSION));
	 ...
	 * @throws AppException
	 */
	public static Blog getBlogDetail(AppContext appContext, final int blog_id)
			throws AppException {
	 ...
	 * @throws AppException
	 */
	public static TweetList getTweetList(AppContext appContext, final int uid,
			final int pageIndex, final int pageSize) throws AppException {
	 ...
	 * @throws AppException
	 */
	public static String report(AppContext appContext, Report report)
			throws AppException {
		Map<String, Object> params = new HashMap<String, Object>();
		...
		try {
			return StringUtils.toConvertString(_post(appContext, URLs.REPORT,
					params, null));
		} catch (Exception e) {
			if (e instanceof AppException)
				throw (AppException) e;
	 ...
	 * @throws AppException
	 */
	public static String signIn(AppContext appContext, Barcode barcode)
			throws AppException {
		try {
			return StringUtils.toConvertString(http_get(appContext,
					barcode.getUrl()));
		} catch (Exception e) {
			if (e instanceof AppException)
				throw (AppException) e;
