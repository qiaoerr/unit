...
public class NewsActivity extends Fragment implements OnItemClickListener {
	...
	private void initData() {
		...
		showType = (int)getArguments().getLong("showType");
	...
	private void initView() {
		...
		adapter = new NewsCommonAdapter(context, myData, listStyle, rowNum ,showType);
	...
	private void upData() {
		...
		api.getArtices(rowNum, -1, firstID, typeID, new RequestListener() {
	...
	private void getHistory() {
		...
		api.getArtices(rowNum, 1, lastID, typeID, new RequestListener() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		if(showType > 0) {
			...
			intent.putExtra("article", myData.get(position));
			context.startActivity(intent);
			
		}else{
			FragmentManager fm = context.getSupportFragmentManager();
			Bundle b = new Bundle();
			b.putSerializable("article", myData.get(position));
