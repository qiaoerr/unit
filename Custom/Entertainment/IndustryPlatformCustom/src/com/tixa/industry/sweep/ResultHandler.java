...
package com.tixa.industry.sweep;
...
import com.tixa.industry.sweep.enterFace.MyMainActivity;
...
public abstract class ResultHandler {
	...
	// private static final String GOOGLE_SHOPPER_PACKAGE =
	// "com.google.android.apps.shopper";
	// private static final String GOOGLE_SHOPPER_ACTIVITY =
	// GOOGLE_SHOPPER_PACKAGE +
	...
	final void addPhoneOnlyContact(String[] phoneNumbers, String[] phoneTypes) {
		addContact(null, null, phoneNumbers, phoneTypes, null, null, null,
				null, null, null, null, null, null, null);
	}

	final void addEmailOnlyContact(String[] emails, String[] emailTypes) {
		addContact(null, null, null, null, emails, emailTypes, null, null,
				null, null, null, null, null, null);
	}

	final void addContact(String[] names, String pronunciation,
			String[] phoneNumbers, String[] phoneTypes, String[] emails,
			String[] emailTypes, String note, String instantMessenger,
			String address, String addressType, String org, String title,
			String url, String birthday) {
	...
	// sendEmailFromUri("mailto:", null,
	// activity.getString(R.string.msg_share_subject_line),
	// contents);
	// }
	...
	// LocaleManager.getCountryTLD(activity) + "/maps?f=d&daddr=" + latitude +
	// ',' + longitude)));
	// }
	...
	// Collection<?> availableApps = pm.queryIntentActivities(intent,
	...
	private String parseCustomSearchURL() {
		SharedPreferences prefs = MyMainActivity.preferences(activity);
		String customProductSearch = prefs.getString(
				MyMainActivity.KEY_CUSTOM_PRODUCT_SEARCH, null);
