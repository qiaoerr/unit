...
final class CameraConfigurationManager {
	...
	private static final int MAX_PREVIEW_PIXELS = 1280 * 720;// ���Ԥ������

	private final Context context;
	private Point screenResolution;// ��Ļ�ֱ���

	private Point cameraResolution;// ���ֱ���
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (prefs.getBoolean(MyMainActivity.KEY_AUTO_FOCUS, true)) {
			if (safeMode
					|| prefs.getBoolean(
							MyMainActivity.KEY_DISABLE_CONTINUOUS_FOCUS, false)) {
	...
	void setTorch(Camera camera, boolean newSetting) {
		...
		boolean currentSetting = prefs.getBoolean(
				MyMainActivity.KEY_FRONT_LIGHT, false);
