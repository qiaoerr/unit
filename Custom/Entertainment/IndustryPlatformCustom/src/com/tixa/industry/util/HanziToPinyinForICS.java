...
public class HanziToPinyinForICS {
    ...
    private static HanziToPinyinForICS sInstance;
    ...
    protected HanziToPinyinForICS(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static HanziToPinyinForICS getInstance() {
        synchronized (HanziToPinyinForICS.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new HanziToPinyinForICS(true);
                    return sInstance;
                }
            }
            Log.w(TAG, "There is no Chinese collator, HanziToPinyin is disabled");
            sInstance = new HanziToPinyinForICS(false);
            return sInstance;
        }
    }
