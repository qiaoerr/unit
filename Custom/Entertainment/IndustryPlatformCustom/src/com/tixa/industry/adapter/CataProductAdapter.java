...
public class CataProductAdapter extends BaseAdapter {
	...
	public CataProductAdapter(Context context, ArrayList<Goods> myData , int listStyle ,int rowNum) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//if(convertView == null) {
		convertView = mInflater.inflate(R.layout.cata_product_list_item, null);
		...
		textDetail = goods.getGoodsDescStr().trim();
