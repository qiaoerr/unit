...
public class TradeAdapter extends BaseAdapter {
	...
	public TradeAdapter(Context context, ArrayList<Exhibition> myData,int rowNum) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.title.setText(myData.get(position).getExName());
		holder.textDetail.setText(myData.get(position).getDetail());
