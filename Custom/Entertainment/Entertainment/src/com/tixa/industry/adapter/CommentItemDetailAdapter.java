 ...
 * 
 */
public class CommentItemDetailAdapter extends BaseAdapter {
	private ArrayList<Comment> dataList;
	private Context context;
	private LayoutInflater inflater;

	public CommentItemDetailAdapter(ArrayList<Comment> dataList, Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.comment.setSingleLine(false);
